...
"Niin kuin Sami ylempänä totesi, tällaisessa sovelluksessa löytyy aina jotain parannettavaa. Edellä mainittujen asioiden lisäksi esimerkiksi testikattavuutta olisi voinut parantaa. Testejä sovellukselle on kirjoiteltu jonkin verran, mutta ne koskevat pääasiassa tärkeimpiä käyttäjälle näytettäviä näkymiä sekä repositoryita. Jotta kattavuus olisi saatu täydeksi olisi pitänyt ehtiä tehdä testit muun muassa kaikille backendin pienille palasille ja adminia olisi ollut hyvä vähän testailla. Omalla kohdallani tämän ryhmätyön tekeminen on ollut hyvin opettavaista, ja web-sovelluksen koodaamisen ohella uudet työkalut kuten slack ja trello ovat tulleet projektin aikana tutuksi." -Marianne Närhi (mariannNar)

"Vaikka erittäin paljon ominaisuuksia saatiinkin toteutettua, niin moniin asioihin jäi vielä paljon hiottavaa. Päällimmäisenä eventtien aloituksen ja lopetuksen näyttäminen jäi kesken ja jokaisesta eventistä tulee nyt kaksi tapahtumaa kalenteriin: aloitus- ja lopetusaika. Tarkoituksena oli näyttää event kerran jokaisella päivällä mihin se sijoittuu. Myös UI:sta profiilisivu ja Event-sivu jäivät designin puolesta melko puutteellisiksi ja sisältävät lähinnä perus html / bootstrap komponenteilla tehdyt elementit eri ominaisuuksista. Sovellus skaalautuu kaikille laitteille melko hyvin, mutta sitäkin olisi voinut miettiä enemmän - ainakaan mitään ei tunnu menevät rikki millään näyttökoolla. Olen kuitenkin kokonaisuuteen erittäin tyytyväinen, ja aion jatkaa sovelluksen kehitystä vielä kurssin jälkeenkin." -Eero Kuurne (eekuurne)
